...
namespace Business.Concrete
{
    public class ProductManeger : IProductService
    {
        ...
        //Bir Maneger sınıfı kendisi hariç başka bir dal'ı enjecte edemez.
        ...
        public IResult Add(Product product)
        {
            IResult result = BusinessRules.Run(CheckIfProductNameExist(product.ProductName),
                CheckIfCategoryCountOfCategoryCorrect(product.CategoryId),
        ...
        private IResult CheckIfProductNameExist(string productName)
        {
            ...
            if (result)
            {
                return new ErrorResult(Messages.ProductNanemAlreadyExists);
            }
            return new SuccessResult();
        }
